...
void UMaterialGraph::RebuildGraphInternal(const TMap<UMaterialExpression*, TArray<UMaterialExpression*>>& SubgraphExpressionMap, const TMap<UMaterialExpression*, TArray<UMaterialExpressionComment*>>& SubgraphCommentMap)
{
	...
	if (!MaterialFunction && !SubgraphExpression)
	{
		...
		MaterialInputs.Add(FMaterialInputInfo(FMaterialAttributeDefinitionMap::GetDisplayNameForMaterial(MP_SpecularOffset, Material), MP_SpecularOffset, LOCTEXT("SpecularOffsetToolTip", "Defines the specular offset of the Material")));
		MaterialInputs.Add(FMaterialInputInfo(FMaterialAttributeDefinitionMap::GetDisplayNameForMaterial(MP_SpecularRange, Material), MP_SpecularRange, LOCTEXT("SpecularRangeToolTip", "Controls the range over which specular highlights are applied")));
		MaterialInputs.Add(FMaterialInputInfo(FMaterialAttributeDefinitionMap::GetDisplayNameForMaterial(MP_ShadowColor, Material), MP_ShadowColor, LOCTEXT("ShadowColorToolTip", "Sets the tint color of dynamic or baked shadows")));
		MaterialInputs.Add(FMaterialInputInfo(FMaterialAttributeDefinitionMap::GetDisplayNameForMaterial(MP_CharaMask, Material), MP_CharaMask, LOCTEXT("CharaMaskToolTip", "Character-specific masking used for layered effects or silhouettes")));
		MaterialInputs.Add(FMaterialInputInfo(FMaterialAttributeDefinitionMap::GetDisplayNameForMaterial(MP_EffectMask, Material), MP_EffectMask, LOCTEXT("EffectMaskToolTip", "Applies a custom mask used for visual effect blending")));
		MaterialInputs.Add(FMaterialInputInfo(FMaterialAttributeDefinitionMap::GetDisplayNameForMaterial(MP_CustomData4, Material), MP_CustomData4, LOCTEXT("CustomData4ToolTip", "Custom user-defined data input channel 4")));
		MaterialInputs.Add(FMaterialInputInfo(FMaterialAttributeDefinitionMap::GetDisplayNameForMaterial(MP_CustomData5, Material), MP_CustomData5, LOCTEXT("CustomData5ToolTip", "Custom user-defined data input channel 5")));
		MaterialInputs.Add(FMaterialInputInfo(FMaterialAttributeDefinitionMap::GetDisplayNameForMaterial(MP_CustomData6, Material), MP_CustomData6, LOCTEXT("CustomData6ToolTip", "Custom user-defined data input channel 6")));
		MaterialInputs.Add(FMaterialInputInfo(FMaterialAttributeDefinitionMap::GetDisplayNameForMaterial(MP_CustomData7, Material), MP_CustomData7, LOCTEXT("CustomData7ToolTip", "Custom user-defined data input channel 7")));
		MaterialInputs.Add(FMaterialInputInfo(FMaterialAttributeDefinitionMap::GetDisplayNameForMaterial(MP_CustomData8, Material), MP_CustomData8, LOCTEXT("CustomData8ToolTip", "Custom user-defined data input channel 8")));
		MaterialInputs.Add(FMaterialInputInfo(FMaterialAttributeDefinitionMap::GetDisplayNameForMaterial(MP_CustomData9, Material), MP_CustomData9, LOCTEXT("CustomData9ToolTip", "Custom user-defined data input channel 9")));
		MaterialInputs.Add(FMaterialInputInfo(FMaterialAttributeDefinitionMap::GetDisplayNameForMaterial(MP_ProjBlendRatioAndZDepthOffset, Material), MP_ProjBlendRatioAndZDepthOffset, LOCTEXT("ProjBlendRatioAndZDepthOffsetToolTip", "Controls the blend ratio and depth offset for projection effects")));
		MaterialInputs.Add(FMaterialInputInfo(FMaterialAttributeDefinitionMap::GetDisplayNameForMaterial(MP_SNKActorRootPosition, Material), MP_SNKActorRootPosition, LOCTEXT("SNKActorRootPositionToolTip", "Provides the root position of the actor for alignment and transforms")));
		MaterialInputs.Add(FMaterialInputInfo(FMaterialAttributeDefinitionMap::GetDisplayNameForMaterial(MP_TransViewOrthoProjM0, Material), MP_TransViewOrthoProjM0, LOCTEXT("TransViewOrthoProjM0ToolTip", "Matrix row 0 for transformed view orthographic projection")));
		MaterialInputs.Add(FMaterialInputInfo(FMaterialAttributeDefinitionMap::GetDisplayNameForMaterial(MP_TransViewOrthoProjM1, Material), MP_TransViewOrthoProjM1, LOCTEXT("TransViewOrthoProjM1ToolTip", "Matrix row 1 for transformed view orthographic projection")));
		MaterialInputs.Add(FMaterialInputInfo(FMaterialAttributeDefinitionMap::GetDisplayNameForMaterial(MP_TransViewOrthoProjM2, Material), MP_TransViewOrthoProjM2, LOCTEXT("TransViewOrthoProjM2ToolTip", "Matrix row 2 for transformed view orthographic projection")));
		MaterialInputs.Add(FMaterialInputInfo(FMaterialAttributeDefinitionMap::GetDisplayNameForMaterial(MP_TransViewOrthoProjM3, Material), MP_TransViewOrthoProjM3, LOCTEXT("TransViewOrthoProjM3ToolTip", "Matrix row 3 for transformed view orthographic projection")));
		MaterialInputs.Add(FMaterialInputInfo(FMaterialAttributeDefinitionMap::GetDisplayNameForMaterial(MP_ViewOrthoProjM3, Material), MP_ViewOrthoProjM3, LOCTEXT("ViewOrthoProjM3ToolTip", "Final row of the view orthographic projection matrix")));
		MaterialInputs.Add(FMaterialInputInfo(FMaterialAttributeDefinitionMap::GetDisplayNameForMaterial(MP_SNKPrevActorRootPosition, Material), MP_SNKPrevActorRootPosition, LOCTEXT("SNKPrevActorRootPositionToolTip", "Previous frame’s SNK actor root position for motion or interpolation")));
		MaterialInputs.Add(FMaterialInputInfo(FMaterialAttributeDefinitionMap::GetDisplayNameForMaterial(MP_PrevTransViewOrthoProjM0, Material), MP_PrevTransViewOrthoProjM0, LOCTEXT("PrevTransViewOrthoProjM0ToolTip", "Previous frame’s matrix row 0 for transformed view ortho projection")));
		MaterialInputs.Add(FMaterialInputInfo(FMaterialAttributeDefinitionMap::GetDisplayNameForMaterial(MP_PrevTransViewOrthoProjM1, Material), MP_PrevTransViewOrthoProjM1, LOCTEXT("PrevTransViewOrthoProjM1ToolTip", "Previous frame’s matrix row 1 for transformed view ortho projection")));
		MaterialInputs.Add(FMaterialInputInfo(FMaterialAttributeDefinitionMap::GetDisplayNameForMaterial(MP_PrevTransViewOrthoProjM2, Material), MP_PrevTransViewOrthoProjM2, LOCTEXT("PrevTransViewOrthoProjM2ToolTip", "Previous frame’s matrix row 2 for transformed view ortho projection")));
		MaterialInputs.Add(FMaterialInputInfo(FMaterialAttributeDefinitionMap::GetDisplayNameForMaterial(MP_PrevTransViewOrthoProjM3, Material), MP_PrevTransViewOrthoProjM3, LOCTEXT("PrevTransViewOrthoProjM3ToolTip", "Previous frame’s matrix row 3 for transformed view ortho projection")));
		MaterialInputs.Add(FMaterialInputInfo(FMaterialAttributeDefinitionMap::GetDisplayNameForMaterial(MP_PrevViewOrthoProjM3, Material), MP_PrevViewOrthoProjM3, LOCTEXT("PrevViewOrthoProjM3ToolTip", "Final row of the previous frame’s view ortho projection matrix")));
		MaterialInputs.Add(FMaterialInputInfo(FMaterialAttributeDefinitionMap::GetDisplayNameForMaterial(MP_SpecialFilterFlag, Material), MP_SpecialFilterFlag, LOCTEXT("SpecialFilterFlagToolTip", "Toggles or defines conditions for special filtering passes")));
		MaterialInputs.Add(FMaterialInputInfo(FMaterialAttributeDefinitionMap::GetDisplayNameForMaterial(MP_OutlineMask, Material), MP_OutlineMask, LOCTEXT("OutlineMaskToolTip", "Defines areas where outlines should be rendered on the material")));
		MaterialInputs.Add(FMaterialInputInfo(FMaterialAttributeDefinitionMap::GetDisplayNameForMaterial(MP_InlineParam, Material), MP_InlineParam, LOCTEXT("InlineParamToolTip", "Controls inline visual behavior, often used for internal compositing")));
		MaterialInputs.Add(FMaterialInputInfo(FMaterialAttributeDefinitionMap::GetDisplayNameForMaterial(MP_AAJitterScale, Material), MP_AAJitterScale, LOCTEXT("AAJitterScaleToolTip", "Scales the jitter amount used in anti-aliasing techniques")));
